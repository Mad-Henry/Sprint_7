...
from data import COURER_CREATION_ERR_LGN_ALRD_EXIST_TXT, COURER_CREATION_ERR_REQUIERD_FLDS_TXT, COURER_CREATION_OK_TRUE_TXT
from data import COURER_LOGIN_CORRECT_CREDS, COURER_LOGIN_NO_LOGIN, COURER_LOGIN_NO_PASS, COURER_LOGIN_ERR_REQUIRED_FLDS_TXT, COURER_LOGIN_ERR_WRONG_FLDS_TXT
